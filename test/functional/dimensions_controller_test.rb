...
class DimensionsControllerTest < ActionController::TestCase
  ...
  test "should create dimension" do
    assert_difference('Dimension.count') do
      post :create, dimension: { description: @dimension.description, name: @dimension.name, status: @dimension.status }
    end
  ...
  test "should update dimension" do
    put :update, id: @dimension, dimension: { description: @dimension.description, name: @dimension.name, status: @dimension.status }
    assert_redirected_to dimension_path(assigns(:dimension))
  end
